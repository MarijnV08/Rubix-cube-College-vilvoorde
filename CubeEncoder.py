...
class CubeEncoder:
    ...
    def get_edges(self):
        ...
        # currently not used
        self.edge_positions = [c[0][0][1], c[0][1][0], c[0][1][2], c[0][2][1], c[1][0][1], c[1][1][0], c[1][1][2],
                               c[1][2][1], c[2][0][1], c[2][1][0], c[2][1][2], c[2][2][1], c[3][0][1], c[3][1][0],
                               c[3][1][2], c[3][2][1], c[4][0][1], c[4][1][0], c[4][1][2], c[4][2][1], c[5][0][1],
                               c[5][1][0], c[5][1][2], c[5][2][1]]
    ...
    def get_vertexes(self):
        ...
        # currently not used
        self.vertex_positions = [c[0][0][0], c[0][0][2], c[0][2][0], c[0][2][2], c[1][0][0], c[1][0][2], c[1][2][0],
                                 c[1][2][2], c[2][0][0], c[2][0][2], c[2][2][0], c[2][2][2], c[3][0][0], c[3][0][2],
                                 c[3][2][0], c[3][2][2], c[4][0][0], c[4][0][2], c[4][2][0], c[4][2][2], c[5][0][0],
                                 c[5][0][2], c[5][2][0], c[5][2][2]]
